...
import { updateStockalAccountInfo, fetchStockalAccountInfo } from '../../../store/slices/stockalSlice';
...
const AccountInfoForm = ({ custId, initialData, onClose }) => {
    ...
    const FormInput = ({ label, name, type = "text", placeholder, required = false, colSpan = "" }) => (
        ...
        <div className="w-full animate-in fade-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                    ...
                    <FormInput label="Annual Income" name="annualIncome" type="number" />
                    <FormInput label="Net Worth Total" name="networthTotal" type="number" />
                </div>
