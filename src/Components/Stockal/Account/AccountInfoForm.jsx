    ...
    useEffect(() => {
        if (initialData) {
            ...
            setFormData(prev => ({
                ...
                country: initialData.address?.countryID || '',
                ...
                address1: initialData.address?.line1 || '',
                address2: initialData.address?.line2 || '',
                city: initialData.address?.city || '',
                state: initialData.address?.stateProvince || '',
                postalCode: initialData.address?.zipPostalCode || '',
