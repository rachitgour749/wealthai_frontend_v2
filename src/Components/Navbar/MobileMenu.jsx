                ...
                <div className="p-4">
                    {isAuthenticated && (
                        <div className="space-y-2">
                            {/* My Profile */}
                            <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-blue-50 transition-colors">
                            ...
                            {/* Subscription */}
                            <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-green-50 transition-colors">
